...
Parqueo parqueoFromJson(String str) => Parqueo.fromJson(json.decode(str));

String parqueoToJson(Parqueo data) => json.encode(data.toJson());
...
class Parqueo {
  ...
  Parqueo.fromJsonList(List<dynamic> jsonList) {
    if (jsonList == null) return;
    jsonList.forEach((item) {
      Parqueo parqueo = Parqueo.fromJson(item);
      toList.add(parqueo);
    });
  }
