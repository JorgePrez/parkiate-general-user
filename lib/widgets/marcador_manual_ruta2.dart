...
class MarcadorManualRuta2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BusquedaBloc, BusquedaState>(
      builder: (context, state) {
        ...
        return _BuildMarcadorManualRuta2(
...
class _BuildMarcadorManualRuta2 extends StatelessWidget {
  final double latitude, longitude;

  _BuildMarcadorManualRuta2({
    Key key,
    this.latitude,
    this.longitude,
  }) : super(key: key);
       ...
       /* Positioned(
            ...
            child: FadeIn(
              child: MaterialButton(
                  ...
                  child: Text('Ver Ruta', style: TextStyle(color: Colors.white)),
                  color: Colors.red,
                //  shape: StadiumBorder(),
                  elevation: 0, //0
                  splashColor: Colors.blue,
